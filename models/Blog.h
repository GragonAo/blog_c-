...
class Blog
{
  public:
     ...
     */
    explicit Blog(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Blog(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const short &getValueOfStatus() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<short> &getStatus() const noexcept;
    ///Set the value of the column status
    void setStatus(const short &pStatus) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> authorId_;
    std::shared_ptr<int32_t> categoryId_;
    std::shared_ptr<short> status_;
